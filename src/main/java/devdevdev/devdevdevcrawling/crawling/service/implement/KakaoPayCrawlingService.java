...
public class KakaoPayCrawlingService implements CrawlingService {
    ...
    public List<CrawledTechArticleDto> crawlTechBlogs(Company company) throws InterruptedException {
        ...
        techBlogUrl = "https://tech.kakaopay.com/";
    ...
    public String crawlPostContents(String postUrl) throws InterruptedException {
        ...
        List<WebElement> contentsList = webDriver.findElement(By.cssSelector(".content .post .markdown")).findElements(By.xpath("//p|//h1|//h2|//h3|//h4"));
