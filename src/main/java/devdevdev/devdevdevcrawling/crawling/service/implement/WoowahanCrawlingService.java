...
public class WoowahanCrawlingService implements CrawlingService {
    ...
    public List<CrawledTechArticleDto> crawlTechBlogs(Company company) throws InterruptedException {
        ...
        for (int i = 1; i <= 42; i++) {
            ...
            for (WebElement post : postElements) {
                ...
                if (post.getAttribute("class").contains("firstpaint")) continue;
        ...
        for (CrawledTechArticleDto techArticle : techArticles) {
            if(techArticle.getTechArticleUrl() == null) continue;
    ...
    public String crawlPostContents(String postUrl) throws InterruptedException {
        ...
        List<WebElement> contentsList = webDriver.findElement(By.className("post-content-body")).findElements(By.xpath("//p|//h1|//h2|//h3|//h4"));
